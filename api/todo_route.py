...
async def list_categories(service: TodoService = Depends(get_todo_service)):
...
async def get_todos_by_category(
    ...
    return await service.get_todos_by_category(category)
...
async def delete_todos_by_category(
    ...
    return await service.delete_todos_by_category(category)
...
async def update_todo(
    ...
    return await service.update_todo(todo_id, todo_update)
